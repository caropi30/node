...
var fecthURL = 'https://jsonplaceholder.typicode.com/posts';
...
function showPost() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetchPosts(fecthURL)];
                case 1:
                    posts = _a.sent();
                    post = posts[0];
                    console.log("Post # ".concat(post.id));
                    // If the userId is 1, then display a note that it's an administrator
                    console.log("Autor: ".concat(post.userId === 1 ? 'Administrator' : post.userId.toString()));
